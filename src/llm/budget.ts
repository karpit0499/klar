...
// 4096 tokens for a resume rewrite that needs about 1,200 — and 4096 is more
...
/**
 * How many tokens a resume rewrite actually needs, from the resume's shape.
 *
 ...
 * generated by the provider. Clamped so a tiny resume still has room for valid
