...
Klar v2.6 is an internal developer preview. Security fixes are made only on the
current `main` branch and the latest preview artifact. Earlier releases are not
...
time or paid support SLA. Reports and any coordinated disclosure discussion are
kept private until a fix or disclosure decision is ready.

## Ordinary public reports

Use public Issues for normal bugs, usability problems, and feature requests:

https://github.com/karpit0499/klar/issues/new/choose
...
builds a redacted preview and opens the appropriate GitHub page only after the
person reviews and confirms it.
