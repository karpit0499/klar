...
assert.equal(isNewerRelease('2.6.0.1'), false)
assert.equal(isNewerRelease('2.6.0.2'), false)
assert.equal(isNewerRelease('2.6.1'), false)
assert.equal(isNewerRelease('2.6.1.1'), true)
